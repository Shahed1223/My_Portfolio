$(document).ready(function () {
  ...
  $(".main-navigation__ul li a").on("click", function () {
    ...
    $("#burger").removeClass("change").attr("aria-expanded", "false");
    $("body").removeClass("stop-scroll");
  });

  /* About me slider - REMOVED DUPLICATE */
...
}); // <-- This closes the $(window).scroll() - WAS MISSING